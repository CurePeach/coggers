...
export const matchesS3: (MatchDto & ExtraMatchProperties)[] = [
  ...
  },
  {
    ...
    duration: getDuration(37, 57),
    dragonSoul: 'infernal',
    events: [
      "Tom didn't buy items Level 1",
      'Clarissa stole baron',
      'Ian was on mute for 20 minutes',
    ],
  },
  {
    id: 316,
    ...
    duration: getDuration(29, 28),
    dragonSoul: 'ocean',
    events: ["James 1v2 solo bolo'd Ian"],
  },
  {
    id: 317,
    ...
    duration: getDuration(33, 25),
    dragonSoul: 'infernal',
    events: ['James solo killed in the counter matchup -James'],
  },
  {
    id: 318,
    ...
    teams: {
      ...
      red: {
        ...
        players: [
          {
            name: PlayerName.Draghau,
            champion: ChampionName.Renekton,
            role: 'top',
            kills: 8,
            deaths: 7,
            assists: 7,
    ...
    duration: getDuration(29, 47),
    dragonSoul: 'infernal',
    events: ["George got 25 stacks of Mejai's -George"],
  },
];
